...
(
    ...
    FILENAME = 'C:\N03_SQLPartitions\PARTITION_ORDERS_2021.ndf',
    SIZE = 5MB,
    FILEGROWTH = 5MB
)
...
(
    ...
    FILENAME = 'C:\N03_SQLPartitions\PARTITION_ORDERS_2022.ndf',
    SIZE = 5MB,
    FILEGROWTH = 5MB
)
...
(
    ...
    FILENAME = 'C:\N03_SQLPartitions\PARTITION_ORDERS_2023.ndf',
    SIZE = 5MB,
    FILEGROWTH = 5MB
)
